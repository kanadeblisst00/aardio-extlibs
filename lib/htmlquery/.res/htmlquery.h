...
extern __declspec(dllexport) GoUint8 ExistsAttr(GoInt nIndex, char* cStrName);
...
extern __declspec(dllexport) GoInt LoadDoc(char* cStrHtmlPath);
extern __declspec(dllexport) GoUint8 OutputHTML(GoInt nIndex, GoUint8 self, char* result);
...
extern __declspec(dllexport) GoUint8 SelectAttr(GoInt nIndex, char* cStrName, char* result);
