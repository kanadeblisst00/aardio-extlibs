...
extern __declspec(dllexport) GoUint8 ChildNodes_Each(GoInt nIndex, GoUintptr funcCallback);
extern __declspec(dllexport) GoUint8 OutputXML(GoInt nIndex, char* result);
